...
class student
{
    int idnum;
    char name[50];
    int Cse, chemistry, mathematics, english, comscience;
    double per;
    char grade;
    void calculate();
public:
...
{
    per=(Cse+chemistry+mathematics+english+comscience)/5.0;
    if(per>=90)
        grade='A+';
    else if(per>=80)
        grade='A';
...
void student::getdata()
{
    ...
    cin.ignore();
    cin.getline(name,50);
    cout<<"\nEnter student's CSE(106) grade: ";
    cin>>Cse;
    cout<<"\nEnter student's chemistry grade: ";
    cin>>chemistry;
    cout<<"\nEnter student's mathematics(105) grade: ";
    cin>>mathematics;
    cout<<"\nEnter student's english grade: ";
    cin>>english;
    cout<<"\nEnter student's CSE(105) grade: ";
    cin>>comscience;
    calculate();
}
...
{
    cout<<idnum<<setw(6)<<" "<<name<<setw(10)<<Cse<<setw(4)<<chemistry<<setw(4)<<mathematics<<setw(4)
...
void class_result()
{
    ...
    cout<<"\n\n\t\tALL STUDENTS RESULT \n\n";
    cout<<"==========================================================\n";
    cout<<"R.No           Name    C     C     M     E    CS    %age      Grade"<<endl;
    cout<<"==========================================================\n";
    while(inFile.read(reinterpret_cast<char *> (&st), sizeof(student)))
    {
        st.show_tabular();
